...
import { IntegrationTypesTestProps, IntegrationTypesTest } from "./integration-types-test";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/integration-types-test.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <integration-types-test message="world!"></integration-types-test>
   */
  return class IntegrationTypesTestBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): IntegrationTypesTestProps {
      const attrs = this.parseAttributes<IntegrationTypesTestProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<IntegrationTypesTest {...this.props} widgetApi={_widgetApi} />, container);
    }
